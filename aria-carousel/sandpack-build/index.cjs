...
function useCarouselCollection(props) {
  let factory = react.useCallback(
    (nodes) => new list.ListCollection(nodes),
    []
  );
...
function useCarouselState(props, ref) {
  ...
  const updateSnaps = react.useCallback(() => {
...
function useAutoplay({
  ...
  const [playing, setPlaying] = react.useState(enabled);
  useInterval(
...
var WrappedItem = collections.Item;
var Context = react.createContext(void 0);
var useCarouselContext = () => react.useContext(Context);
function Carousel({
  children,
  spaceBetweenItems,
  scrollPadding,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Context.Provider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("div", { ...utils.mergeProps(carouselState.rootProps, props), children })
    }
  );
}
function CarouselTabs({ children, ...props }) {
  const { carouselState } = useCarouselContext();
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ...utils.mergeProps(carouselState?.navProps, props), children: carouselState?.pages.map((_, index) => /* @__PURE__ */ jsxRuntime.jsx(react.Fragment, { children: children({
...
function CarouselTab(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", ...utils.mergeProps(navItemProps, props) });
}
function CarouselButton({ dir, ...props }) {
  const { carouselState } = useCarouselContext();
  const buttonProps = dir === "prev" ? carouselState?.prevButtonProps : carouselState?.nextButtonProps;
  return /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", ...utils.mergeProps(buttonProps, props) });
}
function CarouselScroller(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: [...carouselState?.collection || []].map((item) => /* @__PURE__ */ jsxRuntime.jsx(CarouselItem, { item, state: carouselState }, item.key))
    }
  );
}
function CarouselItem(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ...itemProps, children: item.rendered });
}
function CarouselAutoplayControl(props) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      type: "button",
      ...utils.mergeProps(carouselState?.autoplayControlProps, props)
    }
  );
}

exports.Carousel = Carousel;
exports.CarouselAutoplayControl = CarouselAutoplayControl;
exports.CarouselButton = CarouselButton;
exports.CarouselItem = WrappedItem;
exports.CarouselScroller = CarouselScroller;
exports.CarouselTab = CarouselTab;
exports.CarouselTabs = CarouselTabs;
exports.Item = WrappedItem;
exports.useCarousel = useCarousel;
exports.useCarouselItem = useCarouselItem;
exports.useCarouselNavItem = useCarouselNavItem;
